...
<body>
	...
	<div id="headerArea">
		...
		<nav id="navbar">
			<div class="buttons">
				<button id="home"><a href="s_home.php#teleport">Homepage</a></button>
				<button id="view"><a href="s_viewhw.php#teleport">View & Submit Homework</a></button>
			</div>
		</nav>
		<hr>
	</div>
	...
	<form method="POST" action="s_filter.php#teleport">
		<div class="container">
	...
	<form method="POST" action="s_viewhw.php#teleport">
		<table align="center">
			<?php
			// Connect to database
			include("../connection.php");
	...
	if (isset($_POST['submithw'])) {
		...
		foreach ($_POST['homework'] as $x) {
			...
			mysqli_stmt_bind_param($stmt, "ss", $_SESSION['user'], $x);
