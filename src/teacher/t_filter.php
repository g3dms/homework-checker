...
<body style="text-align: center;">
    ...
    <div id="headerArea">
        ...
        <table align="center">
            ...
            if ($_POST['class'] == 'allclass') {
                if ($_POST['subject'] == 'allsub') {
                    // all classes, all subjects
                    $q = "SELECT * FROM homework h;";
                } else {
                    // All classes, but not all subjects
                    $q = "SELECT * FROM homework h WHERE h.subject = '{$_POST['subject']}'";
                }
            } else {
                if ($_POST['subject'] == 'allsub') {
                    // not all classes, all subjects
                    $q = "SELECT * FROM homework h WHERE h.class = '{$_POST['class']}';";
                } else {
                    // not all classes, not all subjects
                    $q = "SELECT * FROM homework h WHERE h.class = '{$_POST['class']}' AND h.subject = '{$_POST['subject']}';";
                }
            }
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<h3>There is no homework.</h3>";
            }
